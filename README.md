...
- the [**Grapevine Relay**](./grapevine-relay/README.md): stores Grapevine-specific data, including G (and R) tables in the form of NIP-51 lists. These come in two flavors:
    - the Personalized Grapevine WoT Relay
    - GRaasS: the Grapevine Relay as a Service
